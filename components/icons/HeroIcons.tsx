...
// Using a single file for HeroIcons-style icons for simplicity
// In a larger project, these would be individual files.
...
export const WrenchScrewdriverIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.664 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.486-6.336l-3.276 3.277a3.004 3.004 0 01-4.243-4.243l3.275-3.275a4.5 4.5 0 00-6.336 4.486c.061.58.035 1.193-.14 1.743m-2.13-4.878c.388.388.728.805.998 1.258" />
    </svg>
);

export const BuildingStorefrontIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A.75.75 0 0114.25 12h.75c.414 0 .75.336.75.75v7.5m0 0H18A2.25 2.25 0 0020.25 18v-7.5a2.25 2.25 0 00-2.25-2.25H15M13.5 21H6A2.25 2.25 0 013.75 18v-7.5a2.25 2.25 0 012.25-2.25h.75c.414 0 .75.336.75.75V21m6-12V3.75A2.25 2.25 0 0013.5 1.5h-3A2.25 2.25 0 008.25 3.75V9m6 0H8.25" />
    </svg>
);
...
export const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-2.438c.155-.158.29-.326.419-.494a1.003 1.003 0 00-.33-1.46c-1.554-.93-3.232-1.542-5.048-1.542-.942 0-1.872.19-2.734.552m-2.734-.552c-.636-.243-1.3-.43-1.99-.552-1.815 0-3.493.612-5.048 1.542a1.003 1.003 0 00-.33 1.46c.129.168.264.336.419.494a9.337 9.337 0 004.121 2.438 9.38 9.38 0 002.625-.372M15 19.128v-1.5a3.375 3.375 0 00-3.375-3.375h-1.5A3.375 3.375 0 006.75 17.628v1.5m9-1.5a9 9 0 00-9 0m9 0a9 9 0 01-9 0m9 0v-1.5a3.375 3.375 0 00-3.375-3.375h-1.5a3.375 3.375 0 00-3.375 3.375v1.5m6.375 0v-1.5a3.375 3.375 0 00-3.375-3.375h-1.5a3.375 3.375 0 00-3.375 3.375v1.5" />
    </svg>
);

export const CubeTransparentIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 7.5l-2.25-1.313M21 7.5v2.25m0-2.25l-2.25 1.313M3 7.5l2.25-1.313M3 7.5l2.25 1.313M3 7.5v2.25m9 3l2.25-1.313M12 12.75l-2.25-1.313M12 12.75V15m0 6.75l2.25-1.313M12 21.75V19.5m0 2.25l-2.25-1.313m0-16.875L12 2.25l2.25 1.313M12 7.5V5.25m0 2.25l-2.25-1.313M12 2.25L9.75 3.563m0 0L7.5 2.25m6.75 21.75l-2.25-1.313M16.5 19.5L12 21.75m3.375-19.5l-2.25-1.313m2.25 1.313L12 5.25" />
    </svg>
);
...
export const ScaleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 01-2.131.352 5.988 5.988 0 01-2.131-.352c-.483-.174-.711-.703-.59-1.202L18.75 4.971zm-16.5.52c.99-.203 1.99-.377 3-.52m0 0l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 01-2.131.352 5.988 5.988 0 01-2.131-.352c-.483-.174-.711-.703-.59-1.202L5.25 4.971z" />
    </svg>
);
...
export const CurrencyDollarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182.99-.789 2.503-.789 3.493 0l.533.424m-3.293 2.818l1.06-1.06" />
    </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72.335c-.44.04-.88.22-1.244.498l-3.72 2.657a1.125 1.125 0 01-1.587-.894v-3.328c0-.43.224-.83.612-1.06l3.72-2.657c.364-.258.785-.417 1.233-.498l3.72-.335zM4.026 15.75l3.72.335c.443.04.88.22 1.244.498l3.72 2.657a1.125 1.125 0 01-1.587.894v-3.328c0-.43-.224-.83-.612-1.06l-3.72-2.657c-.364-.258-.785-.417-1.233-.498L4.026 15.75z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 8.25V7.5a2.25 2.25 0 012.25-2.25h5.25a2.25 2.25 0 012.25 2.25v4.286c0 .443-.19.85-.505 1.15l-2.42 2.234a1.125 1.125 0 01-1.587-.894V11.25a2.25 2.25 0 00-2.25-2.25H4.5a2.25 2.25 0 01-2.25-2.25z" />
    </svg>
);
